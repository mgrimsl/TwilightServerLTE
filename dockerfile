...
ENV GODOT_GAME_NAME="TwilightServer"
ENV HTTPS_GIT_REPO="https://github.com/mgrimsl/TwilightServer.git"
...
RUN godot --export-pack --headless ${GODOT_EXPORT_PRESET} ${GODOT_GAME_NAME}.pck
...
CMD godot --main-pack ${GODOT_GAME_NAME}.pck --headless